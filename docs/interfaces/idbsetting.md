...
| IsUseUpsert | Gets a value that indicates whether the [Insert](/docs/operations/insert.md)/[Update](/docs/operations/update.md) operation will be used for [Merge](/docs/operations/merge.md) operation. |
