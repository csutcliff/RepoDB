...
| Name | Description |
|:-----|:------------|
| Get | The method that is being invoked when the outbound transformation is triggered (i.e.: [Query](/docs/operations/query.md), [QueryAll](/docs/operations/queryall.md) and [BatchQuery](/docs/operations/batchquery.md)). |
| Set | The method that is being invoked when the inbound transformation is triggered (i.e.: [Insert](/docs/operations/insert.md), [Update](/docs/operations/update.md), [Merge](/docs/operations/merge.md) and etc). |
...
```
> When you call any of the fetch ([Query](/docs/operations/query.md), [QueryAll](/docs/operations/queryall.md) and [BatchQuery](/docs/operations/batchquery.md)) or push ([Insert](/docs/operations/insert.md), [Update](/docs/operations/update.md), [Merge](/docs/operations/merge.md)) operations, the methods `Get()` and `Set()`  of the property handler will be invoked immediately.
