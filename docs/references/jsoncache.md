...
This page contains the reference implementation when implementing a file system cache object that is based for JSON. The consolidated output of this page can be found [here](/docs/references/output/jsoncache.md).
