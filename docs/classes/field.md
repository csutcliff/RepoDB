...
- It is used to define a field to be queried during the [Query](/docs/operations/query.md) and [BatchQuery](/docs/operations/batchquery.md) operations.
- It is used to define a field to be affected during push operations like the [Insert](/docs/operations/insert.md), [Merge](/docs/operations/merge.md) and [Update](/docs/operations/update.md) operations.
- It is used to define a qualifier field on the [Merge](/docs/operations/merge.md), [Update](/docs/operations/update.md) and etc.
