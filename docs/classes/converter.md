...
| EnumDefaultDatabaseType | Is used as a default equivalent database type of an enumeration if it is being used as a parameter to the execution of any non-entity-based operations (i.e.: [ExecuteScalar](/docs/operations/executescalar.md), [ExecuteNonQuery](/docs/operations/executenonquery.md) and [ExecuteReader](/docs/operations/executereader.md)). |
