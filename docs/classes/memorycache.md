...
Simply pass the instance in the constructor of the repositories (i.e.: [BaseRepository](/class/baserepository) and [DbRepository](/class/dbrepository)) or when calling the fetched operations (i.e.: [Query](/docs/operations/query.md) and [QueryAll](/docs/operations/queryall.md)).
...
Then, pass it when calling the [Query](/docs/operations/query.md) and [QueryAll](/docs/operations/queryall.md) operations.
