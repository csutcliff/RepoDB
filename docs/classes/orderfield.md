...
This is the class that is being used to define an ordering of the results from any fetch operations (i.e.: [Query](/docs/operations/query.md), [QueryAll](/docs/operations/queryall.md) or [BatchQuery](/docs/operations/batchquery.md)).
