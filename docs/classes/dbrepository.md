...
/* More methods */
```
> Beware of the recurring calls. Ensure to prepend the `base` keyword if your method name is with the same signature as with the base. Please visit our [DbRepository](/docs/references/dbrepository.md) reference implementation page for the detailed implementation.
