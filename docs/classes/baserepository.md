...
```
> Beware of the recurring calls. Ensure to prepend the `base` keyword if your method name is with the same signature as with the base. Please visit our [BaseRepository](/docs/references/baserepository.md) reference implementation page for the detailed implementation.
...
```
> Please visit our [JSON Cache](/docs/references/jsoncache.md) reference implementation page for the detailed implementation about file-based caching using JSON.
...
```
> Please visit our [Trace](/docs/references/trace.md) reference implementation page for the detailed implementation.
