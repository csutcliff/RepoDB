...
This class is a result object of the [ExecuteQueryMultiple](/docs/operations/executequerymultiple.md) operation. It offers you a much more controllability on how to extract the results from the [DbDataReader](https://learn.microsoft.com/en-us/dotnet/api/system.data.common.dbdatareader?view=net-6.0).
...
You need to handle the result of [ExecuteQueryMultiple](/docs/operations/executequerymultiple.md) into a variable and manage the extraction via `Extrac()` method.
