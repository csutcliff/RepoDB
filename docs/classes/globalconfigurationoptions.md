...
| KeyColumnReturnBehavior | A property that is being used to gets or sets the default value of how the push operations (i.e.: [Insert](/docs/operations/insert.md), [InsertAll](/docs/operations/insertall.md), [Merge](/docs/operations/m\erge.md) and [MergeAll](/docs/operations/mergeall.md)) behaves when returning the value from the key columns (i.e.: Primary and Identity). 
