...
This method is used to update all the rows from the client application into the database by bulk. It is only supporting the [SQL Server](https://www.nuget.org/packages/AmpScm.RepoDb.SqlServer.BulkOperations) RDBMS.
...
If you are working to update range of rows from 1000 or more, then use this method over the [UpdateAll](/docs/operations/updateall operation.md).
