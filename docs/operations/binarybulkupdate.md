...
This method is used to update the existing rows from the database by bulk. It is only supporting the [PostgreSQL](https://www.nuget.org/packages/AmpScm.RepoDb.PostgreSql.BulkOperations) RDBMS.
...
If you are working to update range of rows from 1000 or more, then use this method over the [UpdateAll](/docs/operations/updateall.md) operation.
