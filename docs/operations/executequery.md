...
```
You can as well pass an anonymous type in the generic type `TResult` of the [ExecuteQuery](/docs/operations/executequery.md) operation. This scenario is very important to the F# programming language.
