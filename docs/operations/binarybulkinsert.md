...
If you are working to insert range of rows from 1000 or more, then use this method over the [InsertAll](/docs/operations/insertall.md) operation. Alternatively, you can also use the [BinaryImport](/docs/operations/binaryimport.md) operation.
