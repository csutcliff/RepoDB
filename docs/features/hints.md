...
```
> The `hints` argument is only supporting the [SQL Server](https://www.nuget.org/packages/AmpScm.RepoDb.SqlServer). When being called with other RDBMS data providers, an exception will be thrown.
