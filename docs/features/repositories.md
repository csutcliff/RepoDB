...
In the repository, we usually add the basic database operations (i.e.: [Insert](/docs/operations/insert.md), [Delete](/docs/operations/delete.md), [Update](/docs/operations/update.md) and etc), but, here we also place the relevant advance operations usable within the application. Then, all the code in your application that fetches or pushes a data into the database is using this object instead of directly accessing the database. Thus allowing the developers to follow the correct chain-of calls and reusability when it comes to the data accessibility.
...
> Please visit our [BaseRepository](/docs/references/baserepository.md) reference implementation page for the detailed implementation.
...
> Please visit our [DbRepository](/docs/references/dbrepository.md) reference implementation page for the detailed implementation.
...
```
> Please visit our [Generic Repository](/docs/references/genericrepository.md) reference implementation page for the detailed implementation.
