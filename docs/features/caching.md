...
```
> Please visit our [JSON Cache](/docs/references/jsoncache.md) reference implementation page to get more insights on how to implement a file-based caching object using JSON.
