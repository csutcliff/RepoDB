...
Use the [Query](/docs/operations/query.md) operation and pass the target fields to query.
...
Use the [QueryAll](/docs/operations/queryall.md) operation and pass the target fields to query.
...
Use the [Insert](/docs/operations/insert.md) operation and pass the target fields to insert.
...
Use the [InsertAll](/docs/operations/insertall.md) operation and pass the target fields to insert.
...
Use the [Merge](/docs/operations/merge.md) operation and pass the target fields to merge.
...
Use the [MergeAll](/docs/operations/mergeall.md) operation and pass the target fields to merge.
...
Use the [Update](/docs/operations/update.md) operation and pass the target fields to update.
...
Use the [UpdateAll](/docs/operations/updateall.md) operation and pass the target fields to update.
