...
This is a feature that allows you to fetch multiple resultsets in a single call from the database. Both the [ExecuteQueryMultiple](/docs/operations/executequerymultiple.md) and [QueryMultiple](/docs/operations/querymultiple.md) operations were provided to address this need.

The [ExecuteQueryMultiple](/docs/operations/executequerymultiple.md) is a raw method that would allow you to pass your own SQL statement for execution, whereas the [QueryMultiple](/docs/operations/querymultiple.md) is a fluent-method that would allow you to pass a Linq-based query expression and have the library automatically compose the SQL statement for you.
...
The result ordering is available via [OrderField](/class/orderfield) class as part of the execution. For [ExecuteQueryMultiple](/docs/operations/executequerymultiple.md) method, you can write your own ordering during the SQL statement composition. For the [QueryMultiple](/class/sqlservertablehints) method, each order of execution has equivalent `orderBy` argument that you can use.
...
The result filtering is available by simply passing the number of rows during the execution. For [ExecuteQueryMultiple](/docs/operations/executequerymultiple.md) method, you can write your `TOP` or `LIMIT` keyword during SQL statement composition. For the [QueryMultiple](/class/sqlservertablehints) method, each order of execution has equivalent `top` argument that you can use.
...
For fluent-method, you can call the [QueryMultiple](/docs/operations/querymultiple.md) method as below.
...
```
> You can as well visit our [Multiple Resultsets](/docs/references/multipleresultsets.md) reference implementation page for more details.
