...
This enum is used to define the command text to use when executing the [BinaryBulkMerge](/docs/operations/binarybulkmerge.md) operation. It is only used for [PostgreSQL](https://www.nuget.org/packages/AmpScm.RepoDb.PostgreSql.BulkOperations) RDBMS.
