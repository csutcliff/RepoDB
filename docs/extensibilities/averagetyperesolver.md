...
This object is used within the [BaseStatementBuilder](/class/basestatementbuilder) class as a resolver of which system type to be used for conversion when calling the [Average](/docs/operations/average.md) and [AverageAll](/docs/operations/averageall.md) operations.
